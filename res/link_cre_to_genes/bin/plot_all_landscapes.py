...
for landscape_def in ['loop', 'contact']:
    ...
    with sns.plotting_context("paper", rc=rc):
        ...
        sns.despine()
        plt.savefig(f'{RES_PATH}/all_{landscape_def}_enh-num_bytissue_distplot.{fmt}', format=fmt, dpi=400)
        plt.close()
        ### end_fig
        ...
        sns.despine()
        plt.savefig(f'{RES_PATH}/all_{landscape_def}_expvenh-num_bytissue_boxplot_nofliers.{fmt}', format=fmt, dpi=400)
        plt.close()
        ### end_fig
        ...
        sns.despine()
        plt.tight_layout()
        plt.savefig(f'{RES_PATH}/all_{landscape_def}_expvenh-num_bytissue_boxplot_hue.{fmt}', format=fmt, dpi=400)
        plt.close()
        ### end_fig
        ...
        sns.despine()
        plt.tight_layout()
        plt.savefig(f'{RES_PATH}/all_{landscape_def}_expvenh-num_bytissue_H_boxplot_hue.{fmt}', format=fmt, dpi=400)
        plt.close()
        ### end_fig
        ...
        fig = plt.figure(figsize=(10,6))
        g = sns.violinplot(data=enh_by_gene_anno,
        ...
        sns.despine()
        plt.tight_layout()
        plt.savefig(f'{RES_PATH}/all_{landscape_def}_expvenh-num_bytissue_H_violinplot_hue.{fmt}', format=fmt, dpi=400)
        plt.close()
        ### end_fig
        ...
        g = sns.boxplot(data=enh_by_gene_anno,
                        x='enh_num', y='tissue', hue='exp',
                        palette=['tab:gray', 'tab:blue'], showfliers=False)
        g = sns.stripplot(data=enh_by_gene_anno,
    ...
    with sns.plotting_context("paper", rc=rc):
        ...
        g = sns.boxplot(data=enh_by_expgene_anno.query('anno=="tis_spec" | anno=="exp_broad"'),
                           x='frac_tisspec_enh', y='tissue', hue='anno',
        ...
        fig = plt.figure(figsize=(8,10))
        g = sns.boxplot(data=enh_by_expgene_anno.query('anno=="tis_spec" | anno=="exp_broad"'),
                           x='num_tisspec_enh', y='tissue', hue='anno',
                           palette={'exp_broad':'#fee5d9', 'tis_spec':'#de2d26'},
                           showfliers=True, fliersize=1)
        g.set_yticklabels(tis_names)
        ...
        fig = plt.figure(figsize=(10,6))
        g = sns.boxplot(data=enh_by_expgene_anno.query('anno=="tis_spec" | anno=="exp_broad"'),
                        y='frac_tisspec_enh', x='tissue', hue='anno',
                        palette={'exp_broad':'#fee5d9', 'tis_spec':'#de2d26'},
                        showfliers=False)
        g.set_xticklabels(tis_names, rotation=30, horizontalalignment='right')
        ...
        g = sns.violinplot(data=enh_by_expgene_anno.query('anno=="tis_spec" | anno=="exp_broad"'),
                        y='frac_tisspec_enh', x='tissue', hue='anno', inner="quart", linewidth=1,
        ...
        g = sns.boxplot(x='frac_phastcons', hue='anno', y='tissue', data=enh_by_expgene_anno.query('anno=="hk" | anno=="lof_intol" | anno=="exp_nocat"'),
                        ...
                        hue_order=['hk', 'lof_intol', 'exp_nocat'],
                        showfliers=True, fliersize=1)
        g.set_yticklabels(tis_names)
        ...
        sns.despine()
        plt.savefig(f'{RES_PATH}/all_{landscape_def}_genetype_noess_v_fracconsv_bytissue_exponly_fliers_boxplot_hue.{fmt}', format=fmt, dpi=400)
        plt.close()
        ### end_fig
        ...
        g.legend(handles=g.legend_.legendHandles, frameon=False, loc='upper right',
                 labels=['Housekeeping', 'LoF intolerant', 'Expressed'], title='Gene Category')
        sns.despine()
        plt.savefig(f'{RES_PATH}/all_{landscape_def}_genetype_noess_v_enhnum_bytissue_exponly_nofliers_boxplot_hue.{fmt}', format=fmt, dpi=400)
        plt.close()
        ### end_fig
        ...
        g = sns.boxplot(x='enh_num', hue='anno', y='tissue', data=enh_by_expgene_anno.query('anno=="hk" | anno=="essential" | anno=="lof_intol" | anno=="exp_nocat"'),
                        ...
                        hue_order=['hk', 'essential', 'lof_intol', 'exp_nocat'],
                        showfliers=False, fliersize=1)
        g.set_yticklabels(tis_names)
        g.set_xlabel('Number of CREs')
        g.set_ylabel('')
